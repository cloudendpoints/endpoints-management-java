...
public final class ServiceConfigSupplier implements Supplier<Service> {
   ...
   */
  public Service get() {
    String serviceName = this.retrieveEnvironmentVariable(SERVICE_NAME_KEY);
    String serviceVersion = this.retrieveEnvironmentVariable(SERVICE_VERSION_KEY);
  ...
  private String retrieveEnvironmentVariable(String variableName) {
