...
public final class SystemParameters extends com.google.api.client.json.GenericJson {
   ...
   *
   * SystemParameters   rules:     - selector: "*"       parameters:         - name: api_key
   * url_query_parameter: api_key         - name: alt           http_header: Response-Content-Type
   *
   * Example: define 2 api key names for a specific method.
   *
   * SystemParameters   rules:     - selector: "/ListShelves"       parameters:         - name:
   * api_key           http_header: Api-Key1         - name: api_key           http_header: Api-Key2
