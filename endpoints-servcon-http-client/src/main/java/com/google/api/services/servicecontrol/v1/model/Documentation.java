 ...
 * notation: -- internal comment -- Comments can be made conditional using a visibility label. The
 * below text will be only rendered if the `BETA` label is available: --BETA: comment for BETA users
