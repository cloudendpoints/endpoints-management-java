 ...
 * projects. In the example, the `library.googleapis.com/activity_history` log is sent to both the
 * producer and consumer projects, whereas the `library.googleapis.com/purchase_history` log is only
 * sent to the producer project:
 *
 ...
 * description: The name of the branch.     logs:     - name:
 * library.googleapis.com/activity_history       labels:       - key: /customer_id     - name:
 * library.googleapis.com/purchase_history     logging:       producer_destinations:       -
 * monitored_resource: library.googleapis.com/branch         logs:         -
 * library.googleapis.com/activity_history         - library.googleapis.com/purchase_history
 * consumer_destinations:       - monitored_resource: library.googleapis.com/branch         logs:
